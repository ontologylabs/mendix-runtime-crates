...
Examples:
  docker run --rm -v "$PWD":/workspace ontologylabs/mendix-mxbuild:7 build /workspace/App.mpr
  docker run --rm -v "$PWD":/workspace ontologylabs/mendix-mxbuild:7 check /workspace/App.mpr
USAGE
        ;;
