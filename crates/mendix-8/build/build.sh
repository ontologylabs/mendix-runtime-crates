...
Examples:
  docker run --rm -v "$PWD":/workspace ontologylabs/mendix-mxbuild:8 build /workspace/App.mpr
  docker run --rm -v "$PWD":/workspace ontologylabs/mendix-mxbuild:8 check /workspace/App.mpr
USAGE
        ;;
