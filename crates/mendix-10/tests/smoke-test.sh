#!/usr/bin/env bash
# Smoke test for the Mendix 10 runtime crate.
#
...
# Large apps (e.g. EFG) under amd64 emulation need well over 180 s for
# first-boot DDL sync. Override with SMOKE_TIMEOUT=<seconds> if needed.
