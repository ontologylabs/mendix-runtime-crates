...
Examples:
  docker run --rm -v "$PWD":/workspace ontologylabs/mendix-mxbuild:10 build /workspace/App.mpr
  docker run --rm -v "$PWD":/workspace ontologylabs/mendix-mxbuild:10 check /workspace/App.mpr
USAGE
        ;;
